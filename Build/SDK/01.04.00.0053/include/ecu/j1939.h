...
/**
 * @fn u32 j1939_open(j1939_state *state, s32 bus, s32 address, s32 manufacturer, s32 ecu_instance, s32 function_instance, s32 function, s32 vehicle_system, s32 vehicle_instance, s32 industry_group, bool arbitrary_address, s32 rx_tp_slots, s32 tx_tp_slots, s32 rq_slots)
 * @arg ScriptName Open
 * @arg initcall lib
 *
...
static __inline __warn_unused_result u32 j1939_open(j1939_state *s, u32 bus,
    ...
    bool arbitrary_address, u32 rx_tp_slots, u32 tx_tp_slots, u32 rq_slots)
{
	return (u32)s;
}
...
void j1939_open_init(j1939_state *s, u32 bus, u32 address, u32 manufacturer,
    ...
    u32 rx_tp_slots, u32 tx_tp_slots, u32 rq_slots);
...
/**
 * @fn u32 j1939_rx_pg(j1939_rx_pg_state *state, u32 pgn, s32 sa, s32 max_length)
 ...
 */
static __inline __warn_unused_result u32 j1939_rx_pg(j1939_rx_pg_state *s,
    u32 pgn, u32 sa, u32 max_length)
{
	return (u32)s;
}

void j1939_rx_pg_init(j1939_rx_pg_state *s, u32 pgn, u32 sa, u32 max_length);
...
/**
 * @fn s32 j1939_rx_pg_get_length(u32 j1939_rx_pg_handle)
 * @arch ScriptName RxGetLength
 *
 * @brief Get length of data in J1939 receive parameter group
 */
s32 j1939_rx_pg_get_length(u32 j1939_rx_pg_handle);

/**
 * @fn u32 j1939_rx_pg_get_unsignedinteger(u32 j1939_rx_pg_handle, s32 byte, s32 bit, s32 bitlen)
 * @arg ScriptName RxGetUnsignedInteger
 *
 * @details <p>The return value will be the CAN value or 0xFFFFFFFF on error.</p>
 *
 * @brief Read unsigned integer from J1939 receive parameter group
 */
u32 j1939_rx_pg_get_unsignedinteger(u32 j1939_rx_pg_handle, u32 byte, u32 bit,
    u32 bitlen);
...
/**
 * @fn u32 j1939_tx_pg(j1939_tx_pg_state *state, u32 pgn, s32 default_priority, s32 max_length)
 ...
 */
static __inline __warn_unused_result u32 j1939_tx_pg(j1939_tx_pg_state *s,
    u32 pgn, u32 default_priority, u32 max_length)
{
	return (u32)s;
}

void j1939_tx_pg_init(j1939_tx_pg_state *s, u32 pgn, u32 default_priority,
    u32 max_length);
...
/**
 * @fn u32 j1939_dtc(j1939_dtc_state *state, s32 spn)
 * @arg ScriptName DTC
 * @arg initcall lib
 *
...
/**
 * @fn void j1939_dtc_set_active(u32 j1939_dtc_handle, u32 j1939_handle, s32 fmi, s32 mi_lamp, s32 stop_lamp, s32 warning_lamp, s32 protect_lamp)
 ...
 * @details </table>
 *
 * @brief Set DTC fault mode indicator fmi active
 */
void j1939_dtc_set_active(u32 j1939_dtc_handle, u32 j1939_handle, u32 fmi,
    u32 mi_lamp, u32 stop_lamp, u32 warning_lamp, u32 protect_lamp);

/**
 * @overload void j1939_dtc_set_active_simple(u32 j1939_dtc_handle, u32 j1939_handle, s32 fmi)
 */
void j1939_dtc_set_active_simple(u32 j1939_dtc_handle, u32 j1939_handle, u32 fmi);

/**
 * @fn void j1939_dtc_set_inactive(u32 j1939_dtc_handle, u32 j1939_handle, s32 fmi)
 * @arg ScriptName DTCSetInactive
 *
 * @brief Set DCT inactive
 */
void j1939_dtc_set_inactive(u32 j1939_dtc_handle, u32 j1939_handle, u32 fmi);

/**
 * @fn s32 j1939_dtc_count(u32 j1939_dtc_handle, s32 fmi)
 * @arg ScriptName DTCCount
 *
 * @brief Get DTC active count for fault mode indicator fmi
 */
s32 j1939_dtc_count(u32 j1939_dtc_handle, u32 fmi);

/**
 * @fn bool j1939_dtc_active(u32 j1939_dtc_handle, s32 fmi)
 * @arg ScriptName DTCActive
 *
 * @brief Get DTC active state
 */
bool j1939_dtc_active(u32 j1939_dtc_handle, u32 fmi);
