...
Sub TableDeclareData()
	...
	XAxisSize = CInt(Tag("XAxisSize"))
	XAxisMin = CInt(Tag("XAxisMin"))
	XAxisExtrapolate = Tag("XAxisExtrapolate")
	XAxisMandatory = Tag("XAxisMandatory")
	YAxisSize = CInt(Tag("YAxisSize"))
	YAxisMin = CInt(Tag("YAxisMin"))
	YAxisExtrapolate = Tag("YAxisExtrapolate")
	YAxisMandatory = Tag("YAxisMandatory")
	ZAxisSize = CInt(Tag("ZAxisSize"))
	ZAxisMin = CInt(Tag("ZAxisMin"))
