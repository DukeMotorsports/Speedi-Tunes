...
void serial_tx(u32 h, s32 port, u32 len);
...
/**
 * @fn f32 serial_get_float(u32 handle, s32 bitoff)
 * @arg ScriptName GetFloat
 *
 * @brief Read 32-bit IEEE754-2008 floating point number
 *
 * @details <p>The return value will be the Serial value or NAN if an error occurs.</p>
 *
 * @param handle serial handle
 * @param bitoff byte offset (0 to 252)
 *
 * @return Floating point value or NAN on error
 */

__warn_unused_result f32 serial_get_float(u32 h, u32 off);
