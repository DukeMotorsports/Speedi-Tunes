 ...
 * @arg ScriptName NAN
 *
 * @brief Return a value that represents "not a number". Displayed blank (no value) M1 Tune.
 *
 * @return Not a number
 */
 ...
 *
 * @brief Return a value that represents positive infinity. Displayed +inf in M1 Tune.
 *
 * @return Infinity
 */
 ...
 *
 * @details <p>This function tests whether <span class="param">arg</span> is neither
 * @details "Not a Number" or infinity.</p>
 * @details Additionally, a maximum normalized number of either sign
 * @details is also treated as <b>NOT</b> finite. This is because the CPU will return these values for
 * @details a floating point operation on "Not a Number" or infinite values.</p>
 *
 * @param arg input argument
...
/**
 * @fn f32 math_acos(f32 x)
 * @arg ScriptName acos
 *
 * @brief Calculate inverse cosine
 *
 * @details <p>This function calculates the arc cosine of <span class="param"/>x</span>; that is the value whose cosine is <span class="param"/>x</span>.</p>
 *
 * @param x input argument
 * @return On success return the arc cosine of <span class="param"/>x</span> in radians; the return value is in the range [0, pi].
 */

static __inline __warn_unused_result f32 math_acos(f32 x)
{
	return acosf(x);
}

/**
 * @fn f32 math_asin(f32 x)
 * @arg ScriptName asin
 *
 * @brief Calculate inverse sine
 *
 * @details <p>This function calculates the arc sine of <span class="param"/>x</span>; that is the value whose sine is <span class="param"/>x</span>.</p>
 *
 * @param x input argument
 * @return On success return the arc sine of <span class="param"/>x</span> in radians; the return value is in the range [-pi/2, pi/2].
 */

static __inline __warn_unused_result f32 math_asin(f32 x)
{
	return asinf(x);
}

/**
 * @fn f32 math_atan(f32 x)
 * @arg ScriptName atan
 *
 * @brief Calculate inverse tangent
 *
 * @details <p>This function calculates the arc tangent of <span class="param"/>x</span>; that is the value whose tangent is <span class="param"/>x</span></p>
 *
 * @param x input argument
 * @return On success return the arc tangent of <span class="param"/>x</span> in radians; the return value is in the range [-pi/2, pi/2].
 */

static __inline __warn_unused_result f32 math_atan(f32 x)
{
	return atanf(x);
}

/**
 * @fn f32 math_atan2(f32 y, f32 x)
 * @arg ScriptName atan2
 *
 * @brief Calculate inverse tangent including quadrant
 * @details <p>This function calculates the arc tangent of <span class="param"/>y</span>/<span class="param"/>x</span>,
 * @details using the signs of the two arguments to determine the quadrant of the result.</p>
 *
 * @param y y input argument
 * @param x x input argument
 * @return On success return the arc tangent of <span class="param"/>y</span>/<span class="param"/>x</span> in radians; the return value is in the range [-pi, pi].
 */

static __inline __warn_unused_result f32 math_atan2(f32 y, f32 x)
{
	return atan2f(y, x);
}

/**
 * @fn f32 math_ceil(f32 x)
 * @arg ScriptName ceil
 *
 * @brief Calculate ceiling
 *
 * @details <p>This function rounds <span class="param"/>x</span> to
 * @details the next closest integral value towards +inf.
 *
 * @param x input argument
 * @return ceiling of <span class="param"/>x</span>
 */

static __inline __warn_unused_result f32 math_ceil(f32 x)
{
	return ceilf(x);
}

/**
 * @fn f32 math_cosf(f32 x)
 * @arg ScriptName cos
 *
 * @brief Calculate approximate cosine
 *
 * @details <p>This function calculates the approximate cosine of <span class="param"/>x</span>,
 * @details where <span class="param"/>x</span> is given in radians, with a maximum relative error of about 0.5%.</p>
 *
 * @param x input argument
 * @return On success return cosine of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_cosf(f32 x)
{
	return calculate_fcos(x * RAD_2_DEGREE);
}

/**
 * @fn f32 math_coshf(f32 x)
 * @arg ScriptName cosh
 *
 * @brief Calculate hyperbolic cosine
 *
 * @details <p>This function calculates the hyperbolic cosine of <span class="param"/>x</span>,
 * @details which is defined mathematically as: cosh(x) = (exp(x) + exp(-x)) / 2
 *
 * @param x input argument
 * @return On success return the hyperbolic cosine of <span class="param"/>x</span>.
 */
static __inline __warn_unused_result f32 math_coshf(f32 x)
{
	return coshf(x);
}

/**
 * @fn f32 math_expf(f32 x)
 * @arg ScriptName exp
 *
 * @brief Calculate exponential
 *
 * @details <p>This function calculates the value of e (the base of natural logarithms) raised to the power of <span class="param"/>x</span>.</p>
 *
 * @param x input argument
 * @return On success return the exponential value <span class="param"/>x</span>.
 */
static __inline __warn_unused_result f32 math_expf(f32 x)
{
	return expf(x);
}

/**
 * @fn f32 math_fabs(f32 x)
 * @arg ScriptName fabs
 *
 * @brief Calculate absolute value
 *
 * @details <p>This function calculates the absolute value of the floating-point number <span class="param"/>x</span>.</p>
 *
 * @param x input argument
 * @return On success return the absolute value of <span class="param"/>x</span>.
 */
static __inline __warn_unused_result f32 math_fabs(f32 x)
{
	return __builtin_fabs(x);
}

/**
 * @fn f32 math_floorf(f32 x)
 * @arg ScriptName floor
 *
 * @brief Calculate floor
 *
 ...
 *
 * @param x input argument
 * @return floor of <span class="param"/>x</span>
 */

static __inline __warn_unused_result f32 math_floorf(f32 x)
{
	return floorf(x);
}

/**
 * @fn f32 math_fmaxf(f32 x, f32 y)
 * @arg ScriptName fmax
 *
 * @brief Calculate larger value
 *
 * @details <p>This function calculates the larger value of <span class="param"/>x</span> and <span class="param"/>y</span>.</p>
 *
 * @param x input argument
 * @param y input argument
 * @return On success return the maximum value.
 */

static __inline __warn_unused_result f32 math_fmaxf(f32 x, f32 y)
{
	return __builtin_fmaxf(x, y);
}

/**
 * @fn f32 math_fminf(f32 x, f32 y)
 * @arg ScriptName fmin
 *
 * @brief Calculate lesser value
 *
 * @details <p>This function calculates the lesser value of <span class="param"/>x</span> and <span class="param"/>y</span>.</p>
 *
 * @param x input argument
 * @param y input argument
 * @return On success return the minimum value.
 */

static __inline __warn_unused_result f32 math_fminf(f32 x, f32 y)
{
	return __builtin_fminf(x, y);
}

/**
 * @fn f32 math_fmodf(f32 x, f32 y)
 * @arg ScriptName fmod
 *
 * @brief Calculate the floating-point remainder
 *
 * @details <p>This function calculates the floating-point remainder of dividing <span class="param"/>x</span> by <span class="param"/>y</span>.
 * @details The return value is <span class="param"/>x</span> - n * <span class="param"/>y</span>, where n is the quotient of <span class="param"/>x</span> / <span class="param"/>y</span>, rounded toward zero to an integer.</p>
 *
 * @param x numerator
 * @param y denominator
 * @return On success return the value <span class="param"/>x</span> - n*<span class="param"/>y</span>, for some integer n, such that the returned value has the same sign as <span class="param"/>x</span> and a magnitude less than the magnitude of <span class="param"/>y</span>.
 */

static __inline __warn_unused_result f32 math_fmodf(f32 x, f32 y)
{
	return __builtin_fmodf(x, y);
}

/**
 * @fn f32 math_logf(f32 x)
 * @arg ScriptName log
 *
 * @brief Calculate natural logarithm
 *
 * @details <p>This function calculates the natural logarithm of <span class="param"/>x</span></p>
 *
 * @param x input argument
 * @return On success return the natural logarithm of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_logf(f32 x)
{
	return logf(x);
}

/**
 * @fn f32 math_log10f(f32 x)
 * @arg ScriptName log10
 *
 * @brief Calculate base 10 logarithm
 *
 * @details <p>This function calculates the base 10 logarithm of <span class="param"/>x</span></p>
 * * @param x input argument
 * @return On success return the base 10 logarithm of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_log10f(f32 x)
{
	return log10f(x);
}

/**
 * @fn f32 math_pow(f32 x, f32 y)
 * @arg ScriptName pow
 *
 * @brief Calculate x to the power of y
 *
 * @details <p>This function calculates the value of <span class="param"/>x</span> raised to the power of <span class="param"/>y</span>.
 *
 * @param x x input argument
 * @param y y input argument
 * @return On success, these functions return the value of <span class="param"/>x</span> to the power of <span class="param"/>y</span>.
 */

static __inline __warn_unused_result f32 math_pow(f32 x, f32 y)
{
	return powf(x, y);
}

/**
 * @fn f32 math_sinf(f32 x)
 * @arg ScriptName sin
 *
 * @brief Calculate approximate sine
 *
 * @details <p>This function calculates the approximate sine of <span class="param"/>x</span>,
 * @details where <span class="param"/>x</span> is given in radians, with a maximum relative error of about 0.5%.</p>
 *
 * @param x input argument
 * @return On success return the sine of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_sinf(f32 x)
{
	return calculate_fsin(x * RAD_2_DEGREE);
}

/**
 * @fn f32 math_sinhf(f32 x)
 * @arg ScriptName sinh
 *
 * @brief Calculate hyperbolic sine
 *
 * @details <p>This function calculates the hyperbolic sine of <span class="param"/>x</span>,
 * @details which is defined mathematically as: sinh(x) = (exp(x) - exp(-x)) / 2</p>
 *
 * @param x input argument
 * @return On success return the hyperbolic sine of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_sinhf(f32 x)
{
	return sinhf(x);
}

/**
 * @fn f32 math_sqrtf(f32 x)
 * @arg ScriptName sqrt
 *
 * @brief Calculate approximate square root
 *
 * @details <p>This function calculates the approximate square root of <span class="param"/>x</span>,
 * @details where <span class="param"/>x</span> is given in radians, with a maximum relative error of about 0.0013%.</p>
 *
 * @param x input argument
 * @return square root of <span class="param"/>x</span>
 */

static __inline __warn_unused_result f32 math_sqrtf(f32 x)
{
	return calculate_fsqrt(x);
}

/**
 * @fn f32 math_tanf(f32 x)
 * @arg ScriptName tan
 *
 * @brief Calculate approximate tangent
 *
 * @details <p>This function calculates the approximate tangent of of <span class="param"/>x</span>,
 * @details where <span class="param"/>x</span> is given in radians, with a maximum relative error of about 0.5%.</p>
 *
 * @param x input argument
 * @return On success return tangent of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_tanf(f32 x)
{
	return calculate_ftan(x * RAD_2_DEGREE);
}

/**
 * @fn f32 math_tanhf(f32 x)
 * @arg ScriptName tanh
 *
 * @brief Calculate hyperbolic tangent
 *
 * @details <p>This function calculates the hyperbolic tangent of <span class="param"/>x</span>,
 * @details which is defined mathematically as: tanh(x) = sinh(x) / cosh(x)</p>
 *
 * @param x input argument
 * @return On success return the hyperbolic tangent of <span class="param"/>x</span>.
 */

static __inline __warn_unused_result f32 math_tanhf(f32 x)
{
	return tanhf(x);
}
