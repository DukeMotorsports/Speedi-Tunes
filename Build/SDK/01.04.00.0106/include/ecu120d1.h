/* Motec autogenerated header for ecu120d1 */

#include <ecu/types.h>

#define HARDWARE_XML_VERSION 0x010400 /* BCD encoded xml file version */
#define ECU_BOARD 6 /* Unique identifier for ecu120d1 */
...
#define TPU_MAGIC ('d'<<8)
	...
	dout_OUT_HB7 	= TPU_MAGIC + 54,
	dout_OUT_HB8 	= TPU_MAGIC + 56,
...
typedef enum {
	...
	PERIODIC_SLAVE_IGN_LS1 = 32,
	PERIODIC_SLAVE_IGN_LS2 = 33,
	PERIODIC_SLAVE_IGN_LS3 = 34,
	PERIODIC_SLAVE_IGN_LS4 = 35,
	PERIODIC_SLAVE_IGN_LS5 = 36,
	PERIODIC_SLAVE_IGN_LS6 = 37,
	PERIODIC_SLAVE_IGN_LS7 = 38,
	PERIODIC_SLAVE_IGN_LS8 = 39,
	PERIODIC_SLAVE_INJ_LS1 = 48,
	PERIODIC_SLAVE_INJ_LS2 = 49,
	PERIODIC_SLAVE_INJ_LS3 = 50,
	PERIODIC_SLAVE_INJ_LS4 = 51,
	PERIODIC_SLAVE_INJ_LS5 = 52,
	PERIODIC_SLAVE_INJ_LS6 = 53,
