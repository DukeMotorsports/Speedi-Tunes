...
/**
 * @fn u32 j1939_open(j1939_state *state, s32 bus, s32 address, s32 identity, s32 manufacturer, s32 ecu_instance, s32 function_instance, s32 function, s32 vehicle_system, s32 vehicle_instance, s32 industry_group, bool arbitrary_address)
 * @arg ScriptName Open
 * @arg initcall lib bus address identity manufacturer ecu_instance function_instance function vehicle_system vehicle_instance industry_group arbitrary_address
 *
...
static __inline __warn_unused_result u32 j1939_open(j1939_state *s, u32 bus,
    u32 address, u32 identity, u32 manufacturer, u32 ecu_instance,
    u32 function_instance, u32 function, u32 vehicle_system,
    u32 vehicle_instance, u32 industry_group, bool arbitrary_address)
{
	return (u32)s;
}

void j1939_open_init(j1939_state *s, u32 bus, u32 address, u32 identity,
    u32 manufacturer, u32 ecu_instance, u32 function_instance, u32 function,
    u32 vehicle_system, u32 vehicle_instance, u32 industry_group,
    bool arbitrary_address);

/**
 * @overload u32 j1939_open_autoident(j1939_state *state, s32 bus, s32 address, s32 manufacturer, s32 ecu_instance, s32 function_instance, s32 function, s32 vehicle_system, s32 vehicle_instance, s32 industry_group, bool arbitrary_address)
 */
static __inline __warn_unused_result u32 j1939_open_autoident(j1939_state *s,
    u32 bus, u32 address, u32 manufacturer, u32 ecu_instance,
    u32 function_instance, u32 function, u32 vehicle_system,
    u32 vehicle_instance, u32 industry_group, bool arbitrary_address)
{
	return (u32)s;
...
void j1939_open_autoident_init(j1939_state *s, u32 bus, u32 address,
    u32 manufacturer, u32 ecu_instance, u32 function_instance, u32 function,
    u32 vehicle_system, u32 vehicle_instance, u32 industry_group,
    bool arbitrary_address);
 ...
 * @arg initcall lib pgn sa max_length
 *
 ...
 * @arg initcall lib pgn default_priority max_length
 *
