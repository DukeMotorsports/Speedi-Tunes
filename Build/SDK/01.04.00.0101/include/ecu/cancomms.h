 ...
 *
 * @param bus CAN bus
 * @param kbaud baud rate in kilobaud. Supported rates: 1000, 800, 500, 250, 125, 100
 */
...
/**
 * @fn u32 can_bus_rx_msgs(s32 bus)
 * @arg ScriptName BusRxTotal
 *
...
u32 __warn_unused_result can_bus_rx_msgs(u32 bus);

/**
 * @fn u32 can_bus_rx_overrun(s32 bus)
 * @arg ScriptName BusRxOverrun
 *
 * @brief Get the number of messages lost
 *
 * @param bus CAN bus (0 to 2)
 *
 * @return Total number of messages lost
 */

u32 __warn_unused_result can_bus_rx_overrun(u32 bus);

/**
 * @fn u32 can_bus_tx_msgs(s32 bus)
 * @arg ScriptName BusTxTotal
 *
 * @brief Get the number of messages transmitted
 *
 * @param bus CAN bus (0 to 2)
 *
...
u32 __warn_unused_result can_bus_tx_msgs(u32 bus);
