...
typedef struct cancomms_rx_state {
	...
	u8 bufsiz;
	bool bigendian;
	const struct cancomms_rx_msg *msg;
 ...
 * @arg initcall lib bus match mask bigendian
 *
 ...
 * @arg initcall lib return bus match mask bigendian
 *
...
u32 cancomms_rx_open_buffered_std_init(cancomms_rx_buffered_state *s, u32 bus, u32 match, u32 mask,
    bool bigendian);

/**
 * @overload u32 cancomms_rx_open_buffered_std_nofilter(cancomms_rx_buffered_state *state, s32 bus, bool bigendian)
 */

static __inline u32 cancomms_rx_open_buffered_std_nofilter(cancomms_rx_buffered_state *s, u32 bus, bool bigendian)
{
	return cancomms_rx_open_buffered_std(s, 0, 0, 0, 0); /* args are for init only */
}

static __inline u32 cancomms_rx_open_buffered_std_nofilter_init(cancomms_rx_buffered_state *s, u32 bus, bool bigendian)
{
	/* default to open filter, this will be narrowed if cancomms_rx_findmessage_init() is called
	 * by a version of Build that generates these initcalls (eg 1.4.2.x)
	 */
	const u32 match = 0, mask = -1;
	return cancomms_rx_open_buffered_std_init(s, bus, match, mask, bigendian);
}
...
u32 cancomms_rx_open_buffered_ext_init(cancomms_rx_buffered_state *s, u32 bus, u32 match, u32 mask,
    bool bigendian);

/**
 * @overload u32 cancomms_rx_open_buffered_ext_nofilter(cancomms_rx_buffered_state *state, s32 bus, bool bigendian)
 */

static __inline u32 cancomms_rx_open_buffered_ext_nofilter(cancomms_rx_buffered_state *s, u32 bus, bool bigendian)
{
	return cancomms_rx_open_buffered_ext(s, 0, 0, 0, 0); /* args are for init only */
}

static __inline u32 cancomms_rx_open_buffered_ext_nofilter_init(cancomms_rx_buffered_state *s, u32 bus, bool bigendian)
{
	/* default to open filter, this will be narrowed if cancomms_rx_findmessage_init() is called
	 * by a version of Build that generates these initcalls (eg 1.4.2.x)
	 */
	const u32 match = 0, mask = -1;
	return cancomms_rx_open_buffered_ext_init(s, bus, match, mask, bigendian);
}
...
void cancomms_rx_findmessage_init(u32, u32, u32, u32, u32);
