...
/**
 * @fn u32 flash_available(void)
 * @arg ScriptName FlashFree
 *
 * @brief Returns the FLASH available free space (in bytes)
 */
extern u32 __warn_unused_result flash_available(void);
 ...
 *
 * @return a value between 0 and 2147483647 inclusive
 */
extern int __warn_unused_result rand(void);

/**
 * @fn void unused_bool(bool v)
 * @arg ScriptName Unused
 *
 * @brief Use to mark unused local variables and suppress validation error 1350
 *
 * @param v the deliberately unused local variable
*/
static __inline void unused_bool(bool v)
{
}

/**
 * @overload void unused_s32(s32 v)
 */
static __inline void unused_s32(s32 v)
{
}

/**
 * @overload void unused_u32(u32 v)
 */
static __inline void unused_u32(u32 v)
{
}

/**
 * @overload void unused_f32(f32 v)
 */
static __inline void unused_f32(f32 v)
{
}
...
/**
 * @fn s32 hwnum_board(void)
 * @arg ScriptName BoardNumber
 *
 * @brief Returns the ECU Board Number: 0 = 'M170', etc
 *
 * @details <p>ECU Board number mapping.</p>
 * @details <table class=param>
 * @details <tr><th>Return Value</th><th>Hardware type</th></tr>
 * @details <tr><td>0</td><td>M170</td></tr>
 * @details <tr><td>1</td><td>M182</td></tr>
 * @details <tr><td>2</td><td>M190</td></tr>
 * @details <tr><td>4</td><td>M130</td></tr>
 * @details <tr><td>5</td><td>M150</td></tr>
 * @details <tr><td>6</td><td>M141</td></tr>
 * @details <tr><td>7</td><td>M142</td></tr>
 * @details <tr><td>8</td><td>M181</td></tr>
 * @details <tr><td>10</td><td>M122</td></tr>
 * @details <tr><td>11</td><td>VCU</td></tr>
 * @details </table>
 */
extern s32 __warn_unused_result hwnum_board(void);

/**
 * @fn s32 hwnum_schematic(void)
 * @arg ScriptName SchematicNumber
 *
 * @brief Returns the ECU Schematic Number
 */
extern s32 __warn_unused_result hwnum_schematic(void);

/**
 * @fn s32 hwnum_rev(void)
 * @arg ScriptName RevNumber
 *
 * @brief Returns the ECU Rev Number: 0 = 'A', 1 = 'B', etc
 */
extern s32 __warn_unused_result hwnum_rev(void);

/** @} System */

#define to_s32e3(val) (int)((val) * 1.0e3f)

#define TPRINTF_RA(fmt, ...)						\
	tprintf("%p:SDK:" fmt "\n",  __builtin_return_address(0), ## __VA_ARGS__)

void tprintf(const char *, ...) __printf(1);
