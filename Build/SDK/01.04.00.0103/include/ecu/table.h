...
typedef struct {
        interp_0a_f32_cfg*                config;
        interp_0a_f32_state*        state;
} table_0a_handle_t;

typedef struct {
	interp_1a_f32_cfg*		config;
	interp_1a_f32_state*	state;
} table_1a_handle_t;

typedef struct {
	interp_2a_f32_cfg*		config;
	interp_2a_f32_state*	state;
} table_2a_handle_t;

typedef struct {
	interp_3a_f32_cfg*		config;
	interp_3a_f32_state*	state;
} table_3a_handle_t;

typedef table_0a_handle_t* table_0a_handle_p;
typedef table_1a_handle_t* table_1a_handle_p;
typedef table_2a_handle_t* table_2a_handle_p;
typedef table_3a_handle_t* table_3a_handle_p;
