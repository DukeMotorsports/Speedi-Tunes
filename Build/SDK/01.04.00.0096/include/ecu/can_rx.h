...
/**
 * @overload u32 cancomms_rx_open_buffered_std(cancomms_rx_buffered_state *state, s32 bus, bool bigendian)
 */
...
/**
 * @overload u32 cancomms_rx_open_buffered_ext(cancomms_rx_buffered_state *state, s32 bus, bool bigendian)
 */
